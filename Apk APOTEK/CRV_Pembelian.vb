...
Public Class CRV_Pembelian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Apk_APOTEK.CRV_Pembelian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRV_Pembelian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRV_Pembelian = New CRV_Pembelian()
        rpt.Site = Me.Site
        Return rpt
    End Function
