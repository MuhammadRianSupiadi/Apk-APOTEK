...
Public Class Pembelian
    ...
    Public Shared Function Daftar_Obat(keyword As String)
        Call OpenConn()
        Cmd = New MySqlCommand("Select * from pembelian_obat where nama_obat='" & keyword & "'", Conn)
        Rd = Cmd.ExecuteReader()
        Rd.Read()
        If Not Rd.HasRows Then
            Return Nothing
