...
Public Class Form_Pembelian
    ...
    Private Sub Pembelian_Obat_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call Tampilkan()
        LblKodePetugas.Text = Form_Login.txt_petugas.Text
    ...
    Private Sub btn_cetak_Click(sender As Object, e As EventArgs) Handles btn_cetak.Click
        ...
        Lap.Load("..\..\CRV_Pembelian.rpt")
        Lap.SetParameterValue("tanggal1", dtpembelian.Text)
        Lap.SetParameterValue("tanggal2", dtpembelian.Text)
        LPR_Pembelian.CrystalReportViewer1.ReportSource = Lap
